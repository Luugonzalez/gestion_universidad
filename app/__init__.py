...
def create_app() -> Flask:
    ...
    from app.resources import home, universidad_bp, cargo_bp, categoria_cargo_bp, especialidad_bp, tipo_especialidad_bp, grupo_bp, materia_bp, tipo_dedicacion_bp, autoridad_bp, departamento_bp, grado_bp, orientacion_bp, plan_bp, facultad_bp
